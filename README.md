...
# GHADA
### Multilingual AI Financial Safety & Life-Assistance Platform
...
- **`Double-Click-To-Open.bat`** — Launches the local server and opens your default browser to `http://localhost:3000/` automatically.
- **`Click-To-Open.html`** — Browser redirect shortcut to the live application.
...
> Clicking **"Auto-Fill"** on the Sign In page automatically populates these credentials.
...
**GHADA** — *Save First. Invest Second. Borrow Last.*
